/**
 * Type declarations for the polyfills installed as side effects by the
 * `polyfill` package. Applying it augments the global environment with a
 * synthetic `pushstate` window event and a `setImmediate` global function.
 */
export {}
