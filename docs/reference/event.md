...
Where [`echo`](/reference/echo) connects *elements*, this package connects an
...
| Parameter | Type | Description |
|---|---|---|
| `type` | `string` | Event name. Use the past tense — see the [event naming convention](/learn/events-and-echo). |
