...
[Events and Echo](/foundations/events-and-echo) for the concepts; this page is the
contract.
...
Resolved by name through the [`spark`](/build-elements/spark) registry and applied
