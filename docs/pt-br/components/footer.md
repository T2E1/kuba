...
- O `<footer>` interno expõe um landmark `contentinfo` para a página. Use um
  único `kb-footer` por página; um segundo divide esse landmark e torna o "pular
  para o rodapé da página" ambíguo.
