...
[Instalação](/pt-br/learn/installation), e evolui até a versão que você
publicaria.

As receitas assumem que você leu [Eventos e Echo](/pt-br/foundations/events-and-echo);
boa parte do que as deixa curtas é fiação por arcos.

## Receitas

- **[Busca enquanto digita](/pt-br/build-ui/patterns/search-as-you-type)** — um input
...
- **[CRUD de usuários](/pt-br/build-ui/patterns/user-crud)** — adicionar, listar e
  excluir registros. Quatro arcos fechando um ciclo: formulário → dataset →
  lista → dataset.
- **[Navegação declarativa](/pt-br/build-ui/patterns/declarative-navigation)** — um botão
