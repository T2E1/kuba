...
Las recetas asumen que has leído [Eventos y Echo](/es/foundations/events-and-echo);
buena parte de lo que las hace cortas es la conexión por arcos.

## Recetas

- **[Búsqueda al escribir](/es/build-ui/patterns/search-as-you-type)** — un input que
...
- **[CRUD de usuarios](/es/build-ui/patterns/user-crud)** — añadir, listar y eliminar
  registros. Cuatro arcos que cierran un ciclo: formulario → dataset → lista →
  dataset.
- **[Navegación declarativa](/es/build-ui/patterns/declarative-navigation)** — un botón
