...
**[Instalação](/learn/installation)**. Sem build, sem bundler, sem
framework.
...
projetados. Veja **[Componentes › Form](/components/)** para o porquê.
...
- **[Ciclo de vida](/build-elements/lifecycle)** — o que `@define`, `@paint` e
  `@repaint` fazem entre "elemento no HTML" e "pixels na tela".
- **[Eventos e Echo](/foundations/events-and-echo)** — a gramática completa do
  arco, incluindo filtros, e quando preferir um listener.
- **[Componentes](/components/)** — cada elemento com seus atributos,
  estados e ganchos de estilo.
- **[Receitas](/build-ui/patterns/)** — telas completas: busca enquanto digita,
