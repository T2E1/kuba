...
contorná-lo. É isso que mantém os [princípios](/foundations/principles)
...
[princípios](/foundations/principles):
...
| **Constraint Validation API** | Validação nativa em `<kb-input>` e `<kb-textarea>`. |
...
- **[Princípios](/foundations/principles)** — os três que guiam cada
  decisão.
- **[Instalação](/learn/installation)** — uma tag de script, ou uma
  instalação de pacote.
- **[Início rápido](/learn/quick-start)** — um formulário funcionando em
  dez minutos.
