...
- [Redirect](/components/redirect) — `href` versus `route`, e `go()`.
- [router](/build-elements/router) — registro de rotas, `params`, `urlFor`.
- [Eventos e Echo](/foundations/events-and-echo) — casar origens por id, nome ou
  tag.
