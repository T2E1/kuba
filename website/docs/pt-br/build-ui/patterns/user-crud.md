...
formulário, que é para isso que existe o [`<kb-find>`](/components/find).
...
- [Eventos e Echo](/foundations/events-and-echo) — a gramática do arco.
- [Dataset](/components/dataset) — a chave de upsert e seus métodos.
- [Form](/components/form) — renderização de template e o payload enviado.
