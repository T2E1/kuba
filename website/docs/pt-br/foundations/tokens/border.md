...
`hairline` é o padrão para o que faz borda com uma superfície — inputs e cards
contornados. `thin` é a borda do botão, para que um botão contornado se leia
como controle e não como contêiner.
