...
| Grupo | Define |
|---|---|
| [Cores](/foundations/tokens/colors) | A paleta semântica, com um valor claro e um escuro por token. |
| [Tipografia](/foundations/tokens/typography) | Tamanho de fonte, altura de linha, família e peso. |
| [Espaçamento](/foundations/tokens/spacing) | Espaçamento de composição e espaçamento interno (`inset`). |
| [Borda](/foundations/tokens/border) | Raio e espessura. |
| [Sombras](/foundations/tokens/shadows) | Níveis de elevação. |
| [Opacidade](/foundations/tokens/opacity) | Níveis de opacidade para estados e sobreposições. |
...
[Estilização](/build-ui/theming) para saber quando usar cada um.
