...
publica. Onde o [`echo`](/build-elements/echo) conecta *elementos*, este
...
| Parâmetro | Tipo | Descrição |
|---|---|---|
| `type` | `string` | Nome do evento. Use o passado — veja a [convenção de nomes de evento](/foundations/events-and-echo). |
