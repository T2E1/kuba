...
[Ciclo de vida](/build-elements/lifecycle)), **escucha**, **middleware** y **disparo**.
...
- **[Componentes](/components/)** — los elementos construidos con estos
  decorators.
- **[Reference › Packages](/build-elements/)** — cada export, por paquete.
