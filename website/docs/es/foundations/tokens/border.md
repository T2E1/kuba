...
perfectamente redondos como los avatares.
...
`hairline` es el valor por defecto para lo que bordea una superficie — inputs y
tarjetas contorneadas. `thin` es el borde del botón, para que un botón
contorneado se lea como control y no como contenedor.
