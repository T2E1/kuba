...
| Grupo | Define |
|---|---|
| [Colores](/foundations/tokens/colors) | La paleta semántica, con un valor claro y uno oscuro por token. |
| [Tipografía](/foundations/tokens/typography) | Tamaño de fuente, altura de línea, familia y peso. |
| [Espaciado](/foundations/tokens/spacing) | Espaciado de composición y espaciado interno (`inset`). |
| [Borde](/foundations/tokens/border) | Radio y grosor. |
| [Sombras](/foundations/tokens/shadows) | Niveles de elevación. |
| [Opacidad](/foundations/tokens/opacity) | Niveles de opacidad para estados y superposiciones. |
...
[Estilos](/build-ui/theming) para saber cuándo usar cada uno.
