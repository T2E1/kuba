...
**[Instalación](/learn/installation)**. Sin build, sin bundler, sin
framework.
...
proyectan. Ve **[Componentes › Form](/components/)** para saber por qué.
...
- **[Ciclo de vida](/build-elements/lifecycle)** — qué hacen `@define`, `@paint` y
  `@repaint` entre "elemento en el HTML" y "píxeles en pantalla".
- **[Eventos y Echo](/foundations/events-and-echo)** — la gramática completa del
  arco, incluidos los filtros, y cuándo preferir un listener.
- **[Componentes](/components/)** — cada elemento con sus atributos, estados
  y ganchos de estilo.
- **[Recetario](/build-ui/patterns/)** — pantallas completas: búsqueda al escribir,
