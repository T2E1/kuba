...
formulario, que es para lo que existe [`<kb-find>`](/components/find).
...
- [Eventos y Echo](/foundations/events-and-echo) — la gramática del arco.
- [Dataset](/components/dataset) — la clave de upsert y sus métodos.
- [Form](/components/form) — el renderizado del template y el payload enviado.
