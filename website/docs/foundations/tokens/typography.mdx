...
| Token | Value | Sample |
|---|---|---|
| `--font-size-xxxs` | 12px | <span style={{fontSize: 'var(--font-size-xxxs)'}}>Ag</span> |
| `--font-size-xxs` | 14px | <span style={{fontSize: 'var(--font-size-xxs)'}}>Ag</span> |
| `--font-size-xs` | 16px | <span style={{fontSize: 'var(--font-size-xs)'}}>Ag</span> |
| `--font-size-sm` | 20px | <span style={{fontSize: 'var(--font-size-sm)'}}>Ag</span> |
| `--font-size-md` | 24px | <span style={{fontSize: 'var(--font-size-md)'}}>Ag</span> |
| `--font-size-lg` | 32px | <span style={{fontSize: 'var(--font-size-lg)'}}>Ag</span> |
| `--font-size-xl` | 40px | <span style={{fontSize: 'var(--font-size-xl)'}}>Ag</span> |
| `--font-size-xxl` | 48px | <span style={{fontSize: 'var(--font-size-xxl)'}}>Ag</span> |
| `--font-size-xxxl` | 64px | <span style={{fontSize: 'var(--font-size-xxxl)'}}>Ag</span> |
| `--font-size-display` | 80px | <span style={{fontSize: 'var(--font-size-display)'}}>Ag</span> |
| `--font-size-giant` | 96px | <span style={{fontSize: 'var(--font-size-giant)'}}>Ag</span> |
...
| Token | Value | Sample |
|---|---|---|
| `--font-weight-regular` | 400 | <span style={{fontWeight: 'var(--font-weight-regular)'}}>The quick brown fox</span> |
| `--font-weight-medium` | 500 | <span style={{fontWeight: 'var(--font-weight-medium)'}}>The quick brown fox</span> |
| `--font-weight-bold` | 700 | <span style={{fontWeight: 'var(--font-weight-bold)'}}>The quick brown fox</span> |
