...
**[Búsqueda al escribir](/build-ui/patterns/search-as-you-type)**.
...
- **[Introducción](/learn/introduction)** — por qué existe, y el hueco
  que ocupa entre un framework y HTML puro.
- **[Instalación](/learn/installation)** — una etiqueta de script, o
  instalación por paquete.
- **[Inicio rápido](/learn/quick-start)** — un formulario funcionando en diez
  minutos.
- **[Componentes](/components/)** — cada elemento, con ejemplos en vivo.
