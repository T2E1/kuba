...
| Token | Valor | Muestra |
|---|---|---|
| `--font-weight-regular` | 400 | <span style={{fontWeight: 'var(--font-weight-regular)'}}>El veloz murciélago</span> |
| `--font-weight-medium` | 500 | <span style={{fontWeight: 'var(--font-weight-medium)'}}>El veloz murciélago</span> |
| `--font-weight-bold` | 700 | <span style={{fontWeight: 'var(--font-weight-bold)'}}>El veloz murciélago</span> |
