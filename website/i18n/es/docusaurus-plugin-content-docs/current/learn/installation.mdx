...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/npm/@t2e1/kuba@0.2.0-alpha.7/dist/kuba.css"
/>
<script
  type="module"
  src="https://cdn.jsdelivr.net/npm/@t2e1/kuba@0.2.0-alpha.7/dist/kuba.js"
></script>
```
...
**[Reference › Packages](/build-elements/)** para saber qué contiene cada uno.
