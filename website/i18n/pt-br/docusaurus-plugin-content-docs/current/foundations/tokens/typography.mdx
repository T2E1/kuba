...
| Token | Valor | Amostra |
|---|---|---|
| `--font-weight-regular` | 400 | <span style={{fontWeight: 'var(--font-weight-regular)'}}>O rato roeu a roupa</span> |
| `--font-weight-medium` | 500 | <span style={{fontWeight: 'var(--font-weight-medium)'}}>O rato roeu a roupa</span> |
| `--font-weight-bold` | 700 | <span style={{fontWeight: 'var(--font-weight-bold)'}}>O rato roeu a roupa</span> |
