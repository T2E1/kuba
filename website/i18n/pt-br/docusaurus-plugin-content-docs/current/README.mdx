...
**[Busca enquanto digita](/build-ui/patterns/search-as-you-type)**.
...
- **[Introdução](/learn/introduction)** — por que existe, e a lacuna
  que ocupa entre um framework e HTML puro.
- **[Instalação](/learn/installation)** — uma tag de script, ou instalação
  via pacote.
- **[Início rápido](/learn/quick-start)** — um formulário funcionando em
  dez minutos.
- **[Componentes](/components/)** — cada elemento, com exemplos ao vivo.
